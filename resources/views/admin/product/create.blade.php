    ...
    <div class="box-body">
        <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group @error('title') has-error @enderror">
                ...
                <input type="text" name="title" class="form-control" placeholder="Masukkan Produk" value="{{ old('title') }}">
                @error('title')
            ...
            <div class="form-group @error('jumlah') has-error @enderror">
                ...
                <input type="text" name="jumlah" class="form-control" placeholder="Masukkan Jumlah Produk" value="{{ old('jumlah') }}">
                @error('jumlah')
                    <span class="help-block">{{ $message }}</span>
                @enderror
            </div>
